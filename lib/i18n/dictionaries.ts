...
export const en = {
  ...
  maya: {
    ...
    facetime: {
      title: "Video prototype with Maya",
      threadTitle: "Video prototype with Maya",
      cannotSee:
        "Prototype: Maya cannot see you. The camera is unused. Only her face is rendered from the same voice as a regular call.",
    },
...
export const no: Dictionary = {
  ...
  maya: {
    ...
    facetime: {
      title: "Videoprototype med Maya",
      threadTitle: "Videoprototype med Maya",
      cannotSee:
        "Prototype: Maya kan ikke se deg. Kameraet brukes ikke. Bare ansiktet hennes vises, med samme stemme som i et vanlig anrop.",
    },
